...
elseif($act=='pdf_nilai') 
    header("location:pdf_nilai.php");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Source Code SPK Metode AHP dan SAW</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">              
            ...
            <li><a href="?m=kuisioner"><span class="glyphicon glyphicon-file"></span>Kuisioner</a></li>
            <li class="dropdown">
    ...
    <footer class="footer bg-primary">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p>Copyright  <?=date('Y')?> Bilal Eri hartanto</p>
          </div>
          <div class="col-md-6">
            <p><em class="pull-right">181011400094</em></p>
          </div>
        </div>
      </div>
    </footer>
